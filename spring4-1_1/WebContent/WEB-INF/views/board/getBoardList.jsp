...
<table id="dg_board" class="easyui-datagrid" data-options="url:'./jsonGetBoardList.sp4',title:'게시판',toolbar:'#tb_board'" style="width:500px;height:350px">
    <thead>
        <tr>
    ...
    <!-- 글쓰기 화면 --> 
    <div id="dlg_ins" class="easyui-dialog" title="Basic Dialog" data-options="iconCls:'icon-save'closed:'false'", style="width:350px;height:200px;padding:10px">
